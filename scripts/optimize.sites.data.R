...
run_prospect5 <- nimbleCode({
  ...
  reflectance_L_PNM[1:Nwl] <- NIMprospect5(Nmean,
                                           Cabmean,
                                           Carmean,
                                           Cwmean,
                                           Cmmean,
  ...
  reflectance_L_FTS[1:Nwl] <- NIMprospect5(Nmean + beta_N,
                                           Cabmean + beta_Cab,
                                           Carmean + beta_Car,
                                           Cwmean + beta_Cw,
                                           Cmmean + beta_Cm,
  ...
  for (j in 1:Nwl){
    obs_reflectance[j,4] ~ dnorm(creflectance[j,4], sd = max(0,Standard.Dev + beta_SD))
  }
...
hist(param_all[ileaf,0 + param_X] + param_all[ileaf,0 + param_X + 6])  # Tree, FTS
...
# <chr>              <dbl> <dbl>   <dbl>    <dbl>
# 1 liana.effect      0.0154 0.896 0.00456    0.296
# 2 site.effect       0.0268 0.735 0.0111     0.414
# 3 site.liana.effect 0.0300 0.732 0.0104     0.347
